          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href={PHONE_HREF}
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-amber-500 px-8 py-4 text-lg font-bold text-white transition-colors hover:bg-amber-600 active:scale-95"
                >
